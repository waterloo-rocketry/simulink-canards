...
IVP & Initial Value Problem & ODE set to be solved, with inital values\\
...
\hline
$f(x,u)$ & $n {\times} 1$ function & State transition function \\
$h(x)$ & $l {\times} 1$ function & Measurement function \\
$F(x, u)$ & $n {\times} n$ function & State transition Jacobian  \\
...
$K$ & 1 & K & Measured air temperature \\
\hline 
$m$ & & kg & Mass \\
...
$ g $ & & $\frac{\mathrm{m}}{\mathrm{s}^2}$ & Gravitational acceleration \\
\hline
$V_A$ & & $\frac{\mathrm{m}}{\mathrm{s}}$ & Airspeed \\
$ T $ & & K & Air temperature \\
$ \rho $ & & $\frac{\mathrm{kg}}{\mathrm{m}^3}$ & Air density \\
$ p $ & & Pa & Static pressure \\
$\bar p$ & & Pa & Dynamic pressure \\
\end{tabular}
\end{center}
