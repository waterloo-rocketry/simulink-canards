...
or_data = readtable("plant-model\Data\Aurora\OR_Aurora_cycle_0.csv");
...
%% Cd vs Mach table
cd_table = readtable('plant-model\Data\Aurora\CD_vs_MachNumber_2025-01-18.CSV');

% Final lookup table
lookup_table = unique_data;
CD_input = cd_table.Mach(1:1000); % Mach #
CD_data = cd_table.CD(1:1000); % Cd
%plot(CD_input,CD_data)
