...
sweep = 0.114; % calculating que sweep distance
...
% Body
% CnalfaBody = 2 * 1.1 * lTubo * Lr / Ar; %derivative of eq. 3.26 wrt alpha (making the substitution sin^2a = a^2)
Xtube = 0 - logiva - lTubo/2;
...
Cnalfa = (CnAlfaNose + Cnalfat + CnAlfaTail + CnalfaBody); % Total normal force derivative
% Total center of pressure
x_ref = (XB * CnAlfaNose + XTB * Cnalfat + Xtail * CnAlfaTail + CnalfaBody * Xtube) / Cnalfa;
